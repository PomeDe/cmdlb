  ...
  return (
    <div className=" flex flex-col items-center justify-center bg-black font-sans  text-white">
      ...
      <div id="header" className="scroll-mt-36 flex h-170 w-full items-center justify-center">
        ...
        <div className="w-2/3 h-full flex flex-col justify-around text-3xl  items-center" ><div className="w-full flex flex-row items-start ml-10"><p>Name: {ticket.id}</p></div><p>Price: {ticket.id}</p><p>Location: {ticket.id}</p><button className=" w-4/5 h-20 bg-gradient-to-b from-red-900 to-red-500 rounded-xl">Choose Seat</button></div>
