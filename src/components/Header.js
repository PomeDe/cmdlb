    ...
    return (
        <header  className="flex flex-row justify-evenly items-center p-6 sticky space-x-50 bg-black  w-full top-0 z-15 h-30">
            ...
            <div className='flex flex-row items-center space-x-10 '>
                {lang ? <Link href="/Login" className='hover:text-black hover:cursor-pointer transition duration-300 ease-in-out  outline-2 rounded-4xl w-50 h-12 text-xl text-white items-center justify-center flex flex-row '><p>Login / Sign Up</p></Link> : <Link href="/Login" className='hover:text-black hover:cursor-pointer transition duration-300 ease-in-out  outline-2 rounded-4xl w-58 h-12 text-xl text-white items-center justify-center flex flex-row '><p>Нэвтрэх / Бүртгүүлэх</p></Link>}
